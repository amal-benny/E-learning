...
export default function Header({ isLoggedIn }) {
  ...
  return (
    <header className="bg-gray-900 border-b border-gray-300 shadow-md h-18">
      <nav
        aria-label="Global"
          ...
          <a href="/login" className="text-sm/6 font-semibold text-white">
            {isLoggedIn ? (
              <span className="relative inline-block">
                ...
                />
                <span className="absolute right-0 bottom-0 block size-1.5 rounded-full bg-green-500 ring-2 ring-white" />
              </span>
            ) : (
              "Log in"
            )}
